...
class MonitorTest(TestCase):
    ...
    def test_single_frame_message(self):
        ...
        self._monitor._update_output.assert_called_with(27296, 27832, '99.152.117.124')
    ...
    def test_single_frame_multi_message(self):
        ...
        self._monitor._update_output.assert_has_calls(
            [call(27296, 27832, '99.152.117.124'), call(27304, 27760, '99.152.117.124')]
        )
    ...
    def test_multiple_frame_message(self):
        ...
        self._monitor._update_output.assert_called_once()
        self._monitor._update_output.assert_called_with(1978872, 208192, '99.152.117.124')
    ...
    def test_multiple_frame_with_naked_header(self):
        ...
        self._monitor._update_output.assert_called_once()
        self._monitor._update_output.assert_called_with(570848, 51624, '99.152.117.124')
